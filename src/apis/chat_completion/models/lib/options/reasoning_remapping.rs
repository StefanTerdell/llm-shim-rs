...
use crate::apis::chat_completion::models::api::response::common::ChatCompletionResponseMessage;
...
mod tests {
    ...
    mod helpers {
        use super::*;
        use crate::apis::chat_completion::models::api::common::CommonChatCompletionMessage;
        use std::fmt::Display;
